...
import com.nic.ev.model.SanctionOrder;
...
public class SanctionOrderController {
	...
	private Map<String, Object> getToApprove(@Valid @RequestBody String appl_no){
    	...
    	System.out.println(numberToWord(amnt));
    	
    	System.out.println(so.get("sub_amnt"));
