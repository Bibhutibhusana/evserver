...
public class VehicleDetailsInsertController {
	...
	private ResponseEntity<VahanDetailsDTO> checkIfExists(@PathVariable(value = "id") String regn)
			throws ResourceNotFoundException, BusinessException {
		try {
			VehicleDetailsModel vdm = vehicleDetailsRepo.findById(regn)
	...
	private ResponseEntity<VahanDetailsDTO> insertVehicleDetails(@Valid @RequestBody VahanDetailsDTO vehicleDetailsdto)
